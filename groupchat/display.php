...
<body>
  ...
  <div class="lastsection">
    <div class="bg">
      <img src="" alt="">
      <p> <strong> <?php echo $room_name ?> </strong></p>
      <p> <strong>
          <?php
          // $query = "SELECT COUNT(DISTINCT name) AS total_count FROM groupchat WHERE chat_room = $gid";
      ...
      <?php
      // $query = "SELECT DISTINCT name, p_p FROM groupchat WHERE chat_room = $gid";
      // $result = mysqli_query($conn, $query);
      ...
      //     // Display the name and p_p
      //     echo "<li style='display: flex; align-items: center;'>";
      //     echo "<img src='http://localhost/main/client/assets/uploads/$p_p' height='36px' width='36px' style='margin-right: 10px;'>";
      //     echo " $name";
      //     echo "</li>";
      //   }
      // } else {
