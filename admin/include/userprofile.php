...
$sql = "SELECT user_id,name, username,lastname, password,email,gender, p_p, is_blocked  FROM users";
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <!-- <button style="display:" class="m-1 btn btn-danger btn-sm block_user_btn ub"
                                        ...
                                        <?php 
                                        if($row["is_blocked"] ==1){
                                            echo '<p> <a href="include/blockuser.php?uid='.$row['user_id']. '&is_blocked=0">UnBlock </a> </p>';

                                        }else{
                                            echo '<p> <a href="include/blockuser.php?uid='.$row['user_id']. '&is_blocked=1">Block </a> </p>';
