...
margin-top: 64px;">
    ...
    <div class="userprofile">
        <img class="rounded-circle mt-5" src="assets/uploads/<?=$chatWith['p_p']?>" width="168" height="168"
            style="border:2px solid white"><span class="font-weight-bold"> <br>
                        ...
                        <div class="image_post" style="display: flex; ">
                            ...
                            <div class="" style="margin-left: 7px;">
                                ...
                                <input type="text" name="something" style="    width: 15pc;"
                                    placeholder="Write For ..<?php  echo $chatWith['name'] ?>"> <br>
                            </div>
