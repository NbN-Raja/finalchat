...
$sql = "SELECT user_id,name, username,lastname, password,email,gender, p_p ,last_seen,is_blocked FROM users WHERE user_id= '$user_id'";
...
<div class="userprofile">
                <img class="rounded-circle mt-5" src="assets/uploads/<?=$user['p_p']?>" width="168" height="168" style="border:2px solid white"><span
                    class="font-weight-bold"> <br>
                    
                        
                    
                    <span> <p style="position: relative;top: 33px;">  <?php  echo $name ?>
                        <?php  echo $lastname ?> </p>  </span>
        ...
        justify-content: space-around;position: sticky;position:sticky;top:0">
            ...
            <p  id="show">
             <img src="https://static.xx.fbcdn.net/rsrc.php/v3/yl/r/tmaz0VO75BB.png" 
                height="17" width="17"> <a>Edit  Profile  </a>   </p> 
             <p  id="">
                  <a href="home.php"> Posts</a> </p> 
                   <p  id="">
                      <a href="final_one.php">Chats</a> </p> 
                       <p  id="show">
...
<div class="center hideform">
    ...
    <form action="update_user.php" method="post">
        ...
        <div class="main" style="display: flex; justify-content: space-between;"> 
            <div class="submain">
        <p> FirstName </p>
        <div class="col-md-4"><input type="text" class="form-control" name="name" placeholder="first name"
                value="<?php echo  $name?>"></div>
        <p> LastName </p>
        <div class="col-md-4"><input type="text" class="form-control" name="lastname" value="<?php echo  $lastname?>"
                placeholder="Doe"></div>
            </div>
            <div class="lastmain">
        <p> Email </p>
        <div class="col-md-4"><input type="text" class="form-control" name="email" placeholder="Email"
                value="<?php  echo $email ?> "></div>
        <p> Gender </p>
        <div class="col-md-4"><input type="text" class="form-control" name="gender" value="<?php  echo $gender ?>"
        ...
        <div class="post">
            <form action="posting.php" method="post" enctype="multipart/form-data" >
                ...
                <div class="image_post" style="display: flex; ">
                    <div class="" >
                        <img src="assets/uploads/<?=$user['p_p']?>" class="w-30 rounded-circle"
                            style="width:36px; height: 36px; left: 19pc;">
                    </div>
            
                    <div class="" style="margin-left: 7px;">
            
                        <input type="text" name="something" style="    width: 15pc;"
